<?php
$test = "host={$_GET["Server"]} port={$_GET["Port"]} dbname='{$_GET["Database"]}' user='{$_GET["User"]}' password='{$_GET["Password"]}'";
$Connection = pg_connect("host={$_GET["Server"]} port={$_GET["Port"]} dbname='{$_GET["Database"]}' user='{$_GET["User"]}' password='{$_GET["Password"]}'") or DIE("HARD");
pg_query($Connection, "--
...
DROP DATABASE \"GCentrix\";
--
-- TOC entry 2019 (class 1262 OID 16393)
-- Name: GCentrix; Type: DATABASE; Schema: -; Owner: -
--

CREATE DATABASE \"GCentrix\" WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'German_Germany.1252' LC_CTYPE = 'German_Germany.1252';
